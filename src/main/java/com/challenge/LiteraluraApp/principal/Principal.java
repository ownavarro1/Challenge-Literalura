package com.challenge.LiteraluraApp.principal;

import com.challenge.LiteraluraApp.model.*;
...
import com.challenge.LiteraluraApp.service.ConsumoAPI;
import com.challenge.LiteraluraApp.service.ConvierteDatos;
...
public class Principal {
            ...
            try {
                ...
                switch (Integer.valueOf(opcion)) {
                    ...
                    case 7:
                        ...
                        break;
                    default:
                        System.out.println("Haz ingresado una opción no válida. intenta nuevamente.");
                ...
                System.out.println("Ingreso no válido. intenta nuevamente. " + e.getMessage());
            } catch (Exception e) {
    ...
    private void insertarLibroEnBaseDeDatos(DatosLibro libroBuscado){
        ...
        if(libroBD.isPresent()){
            System.out.println("\n El libro ya se encuentra registrado en BD");
        }else {
